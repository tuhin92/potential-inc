...
const Banner = () => {
  return (
    <div className="font-poppins py-6 md:py-24">
      <div className="flex flex-col lg:flex-row justify-between items-center">
        <div className="text-center lg:text-left">
          <h4 className="text-[#000000] font-semibold text-[20px] md:text-[24px]">Hi I am</h4>
          ...
          <div className="font-bold text-[60px] md:text-[100px] text-[#000000]">
            ...
            <h1 className="text-[50px] md:text-[70px] font-bold ml-0 md:ml-28">Designer</h1>
          </div>
          <p className="py-6 text-base md:text-xl text-[#000000]">
            Lorem ipsum dolor sit amet consectetur. Tristique amet sed <br /> massa
            nibh lectus netus in. Aliquet donec morbi convallis <br /> pretium. Turpis
            tempus pharetra.
          </p>
